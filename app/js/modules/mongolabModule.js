angular.module('mongolabResource', ['ngResource']).factory('$mongolabResource', ['$resource', 'VXhQs2Rt2_gD6l-lko2fAbXHHIncKJuV', 'flatangle', function ($resource, API_KEY, DB_NAME) {
