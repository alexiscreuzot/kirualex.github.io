...
function SignaturePad (selector, options) {
  ...
  function drawIt () {
   ...
   function drawsegments(paths, context, i){
    context.beginPath();
    ...
    if(i < paths.length){
      if (settings.animateSpeed){
        setTimeout(function(){drawsegments(paths, context, i)}, settings.animateSpeed);
      }else{
        drawsegments(paths, context, i);
      }
    }
...
$.fn.signaturePad.defaults = {
  ...
  , bgColour: 'transparent' // The colour fill for the background of the canvas
  , penColour: '#195994' // Colour of the drawing ink
  ...
  , animateSpeed : 0 //Animation speed (ms), 0 for none
}
}(jQuery))
